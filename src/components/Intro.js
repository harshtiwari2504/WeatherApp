    ...
    return(
        ...
        <div className="  my-8  text-center items-center justify-center flex flex-col">
            <div className="flex flex-col items-center text-center justify-center" >
                ...
                <img className="w-full" src={`https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`}  alt="icon"/>
            </div>

            <div className="flex flex-col items-center justify-center text-center mt-5 gap-5">
